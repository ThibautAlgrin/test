...
EOT
    ...
    {
        $generator = new DoctrineRESTGenerator($this->getContainer()->get('filesystem'));
        $generator->setRouting($this->getContainer()->get('fos_rest.routing.loader.reader.controller'));
        $generator->setRouter($this->getContainer()->get('router'));
        $generator->setFactoryMockers($this->getContainer()->get('voryx.restgenerator.factory_mocker'));
        return $generator;
    }
